        ...
        <div class = "form-properties">
            ...
            <form id = "form"  name= "myForm" action="./validate.php" method="POST">
                <div class='form-style'>
                    ...
                    <div>
                        <input class = "input-style" type = "text" name="firstName" id = "firstName">
                ...
                <div class='form-style'>
                    ...
                    <div>
                        <input class = "input-style" type = "text" name="lastName" id = "lastName">
                        <small class="errorMessage"></small>
                    </div>
                </div>       
                ...
                <div class='form-style'>
                    ...
                    <input class = "input-style" type = "tel" name="PhoneNumber" id = "PhoneNumber">
                    <small class="errorMessage"></small>
                </div> 
                ...
                <div class='form-style'>
                    ...
                    <select class = "select-style" name="language" id = "language">
                ...
                <div class='form-style'>
                    ...
                    <input class = "input-style" type = "text" name="ZipCode" id = "zipCode">
                    <small > Error message</small>
                </div> 
